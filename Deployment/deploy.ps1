...
function validateresourcesnames {
    ...
    $resources = @(@{
        ...
        @{
            name               = $parameters.baseresourcename.value + '-apisend-function'
            servicetype        = 'webapp'
            authorizationtoken = $authorizationtoken
        },
        @{
...
function DeployARMTemplate {
    ...
    try {
        ...
        "$($parameters.BaseResourceName.Value)-apisend-function" #apisend-function
        )
...
# Function call to Deploy ARM Template
    ...
    if($parameters.useCertificate.Value){
        ...
        ImportKeyVaultCertificate $keyVaultName "$($parameters.BaseResourceName.Value)-apisend-function"
