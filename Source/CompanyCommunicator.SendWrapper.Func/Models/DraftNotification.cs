...
namespace Microsoft.Teams.Apps.CompanyCommunicator.SendWrapper.Func.Models
{
    ...
    public class DraftNotification : BaseNotification
    {
        ...
        /// <summary>
        /// Gets or sets the json content as string of the Adaptive Card.
        /// </summary>
        public string AdaptiveCardContent { get; set; }

        /// <summary>
        /// Gets or sets the custom instance Id to be used on the last send function for tracking.
        /// </summary>
        public string SendInstanceId { get; set; }
